...
import worker.Work
import worker.backend.WorkManager.SubmitWork
import worker.backend.{WorkManager, WorkManagerSingleton}
...
class FrontEnd private (masterProxy: ActorRef[SubmitWork],
